...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['name']) && $_POST['name'] !== '') {
        ...
        $age = $_POST['age'];
        $grade = $_POST['grade'];
        $stm = $db->prepare("INSERT INTO students (name, age, grade) VALUES (?, ?, ?)");
        $stm->execute([$name, $age, $grade]);
    }
}
...
<body>
    <div class="container">
        ...
        <form method="POST">
            ...
            <input type="number" name="age" placeholder="Da'da">
